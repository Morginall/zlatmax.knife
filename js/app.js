(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".content-main__slider")) new core(".content-main__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".slider-main__slide:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".products-slider__slider")) new core(".products-slider__slider", {
                ...
                pagination: {
                    el: ".control-products-slider__dotts",
                    clickable: true,
                    dynamicBullets: true
                },
                breakpoints: {
            ...
            if (document.querySelector(".products-new__slider")) new core(".products-new__slider", {
                ...
                pagination: {
                    el: ".control-products-new__dotts",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".images-product")) {
                var swiper = new core(".thumbs-product", {
                    modules: [ Pagination, Autoplay, Parallax ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    const activeLink = document.querySelector("._menu-active");
                    const activeBlock = document.querySelector("._sub-menu-open");
                    if (activeLink && activeLink !== targetElement) {
                        activeLink.classList.remove("_menu-active");
                        activeBlock.classList.remove("_sub-menu-open");
                        document.documentElement.classList.remove("_catalog-open");
                    }
                    targetElement.classList.toggle("_menu-active");
                    subMenu.classList.toggle("_sub-menu-open");
                    document.documentElement.classList.toggle("_catalog-open");
                } else console.log("Ой, что-то пошло нет так!");
                e.preventDefault();
            }
        }
        window["FLS"] = true;
